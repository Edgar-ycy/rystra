# Rystra（Rust 反向代理 / frp 类工具）

Rystra 是一个使用 **Rust** 编写的、**自主可控、强工程化、可长期演进** 的反向代理系统，定位为 **frp 类工具的工程化替代方案**。
...
> 当前状态：🚧 Early Development / Architecture-First
...
- [ ] 控制面协议（Hello / Auth / Heartbeat / RegisterProxy / OpenStream）
- [ ] TCP Transport 插件
- [ ] TCP Proxy 插件
- [ ] Token Auth 插件
- [ ] Server ↔ Client TCP 反向代理闭环
